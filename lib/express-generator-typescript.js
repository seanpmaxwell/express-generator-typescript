...
const dependencies = 'express dotenv http-status-codes morgan cookie-parser jet-logger ' +
  'module-alias command-line-args express-async-errors helmet jsonfile bcrypt jsonwebtoken';

// Project-folder development dependencies
const devDependencies = 'ts-node typescript nodemon find jasmine supertest ' +
  '@types/node @types/express @types/jasmine @types/find @types/morgan @types/cookie-parser ' +
  '@types/supertest fs-extra tsconfig-paths @types/jsonfile @types/command-line-args ' +
  '@typescript-eslint/eslint-plugin @typescript-eslint/parser eslint @types/fs-extra ' +
  '@types/bcrypt @types/jsonwebtoken eslint-plugin-node';
