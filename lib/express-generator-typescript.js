...
const DEPENDENCIES = 'express dotenv morgan cookie-parser jet-logger ' +
  'module-alias helmet jsonfile inserturlparams jet-paths dayjs jet-env ' + 
  'jet-validators',
  DEV_DEPENDENCIES = 'ts-node typescript nodemon find supertest vitest ' +
    '@types/node @types/find @types/morgan @types/cookie-parser ' +
    '@types/supertest fs-extra tsconfig-paths jiti @swc/core @types/jsonfile ' +
    '@types/fs-extra @types/module-alias @stylistic/eslint-plugin-js eslint ' +
    '@eslint/js typescript-eslint eslint-plugin-n @stylistic/eslint-plugin-ts';
