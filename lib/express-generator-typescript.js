...
const dependencies = 'express dotenv morgan cookie-parser jet-logger ' +
  ...
  'bcrypt jsonwebtoken jet-validator ts-command-line-args';
...
const devDependencies = 'ts-node typescript nodemon find jasmine supertest ' +
  ...
  '@types/jsonfile @typescript-eslint/eslint-plugin eslint ' +
  '@typescript-eslint/parser @types/fs-extra @types/bcrypt ' + 
  '@types/jsonwebtoken eslint-plugin-node';
